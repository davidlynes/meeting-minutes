...
export function SetupOverviewStep() {
  ...
  const steps = [
    ...
    },
    {
      number: 2,
      type: 'summarization',
      title: 'Download Summarisation Engine',
    },
  ];
  ...
  return (
    <OnboardingContainer
      ...
      description="IQ:capture requires that you download the Transcription & Summarisation AI models for the software to work."
      step={2}
