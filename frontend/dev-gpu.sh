#!/bin/bash
# GPU-accelerated development script for IQ:capture
...
echo -e "${BLUE}🚀 IQ:capture GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting IQ:capture in development mode...${NC}"
echo ""
