@echo off
REM IQ:capture GPU-Accelerated Development Script for Windows
...
echo.
echo ========================================
echo   IQ:capture GPU-Accelerated Development
echo ========================================
echo.
...
echo.
echo 📦 Starting IQ:capture in development mode...
echo.
...
echo.
echo ========================================
echo   IQ:capture GPU Development Script - Help
echo ========================================
echo.
echo USAGE:
...
echo   IQ:capture in development mode with optimal hardware acceleration:
echo.
